...
estimated_insurance_costs = [x[1] for x in estimated_insurance_data]
actual_insurance_costs = [x[1] for x in insurance_data]

insurance_cost_difference = [est - act for est, act in zip(estimated_insurance_costs, actual_insurance_costs)]
